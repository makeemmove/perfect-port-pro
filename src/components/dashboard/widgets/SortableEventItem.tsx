...
const SortableEventItem = ({ id, event, onEventClick }: SortableEventItemProps) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex items-center gap-2 py-1.5 px-4 rounded-full bg-card shadow-card border-0 active:scale-[0.95] transition-transform duration-150 group/event"
    >
      <button
