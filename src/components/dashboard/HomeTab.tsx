...
const HomeTab = ({ onNavigate, newsArticles, onNewsClick, weather }: { onNavigate?: (tab: 'eats' | 'events') => void; newsArticles?: NewsArticle[]; onNewsClick?: () => void; weather?: WeatherData | null }) => {
  ...
  return (
    <div className="space-y-3 relative">
      ...
      {/* Header */}
      <div className="text-center -mt-4 -mb-4 pb-0 relative z-20">
        <div className="flex items-center justify-center gap-3">
          <button
            onClick={editMode ? handleSave : () => setEditMode(true)}
            className={`absolute left-0 top-12 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
              editMode
